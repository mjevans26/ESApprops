...
plot_ly(type = "scatter", mode = "lines", line = list(color = "blue"))%>%
  add_trace(data = FWS, x = ~Year, y = ~ top*CF2016, line = list(color = "orange", dash = "dash"), name = "Top 5%<br>(click to show)",
  ...
  add_trace(data = FWS, x = ~Year, y = ~mn*CF2016, name = "FWS Average", line = list(color = substr(viridis(4),1,7)[2]),
  ...
  add_trace(data = Fed, x = ~Year, y = ~ top*CF2016, type = "scatter", name = "Top 5%<br>(click to show)", line = list(color = "orange", dash = "dash"),
  ...
  add_trace(data = Fed, x = ~Year, y = ~mn*CF2016, name = "Other Fed<br>Average", line = list(color = substr(viridis(4),1,7)[1]),
