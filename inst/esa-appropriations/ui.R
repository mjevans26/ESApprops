...
body <- dashboardBody(
  tags$head(
    tags$link(rel = "styleshet", type = "text/css", href = "bootstrap.css"),
  ...
  navbarPage(collapsible = TRUE,
             ...
             # column(8, h4("Defenders of Widlife", br(), "Center for Conservation Innovation"))),
             title = a(href = "http://www.defenders.org", h4("Defenders of Wildlife, CCI")),
   tabPanel(h4("Overview"),id = "summary",
    fluidPage(
     fluidRow(br()),
     fluidRow(
      column(2,br()),
      column(8, h2("The Importance of Properly Funding the ESA"),
       ...
       tags$figure(class = "figure",
                   tags$img(src = "Island_Fox.jpg",
                            class = "img-responsive",
                            alt = "Island fox"),
                   tags$figcaption(class = "figure-caption", "Photo courtesy of National Park Service")),
       br(),
     ...
     fluidRow(column(2, br()),
             ...
             column(1, br()),
             column(2,
                    div(HTML('<br /> Email questions or comments to <a href = "mailto:esa@defender.org"> esa@defenders.org </a>'),
                        style = "text-align: center"))
      )
     )
    ),

   tabPanel(h4("Funding Needs"), id = "panel2",
    fluidPage(
     fluidRow(br()),
     fluidRow(column(3, br()),
              column(9, h4("Species Recovery Funding and Status"))
              ),
     fluidRow(
      ...
      column(4,
       ...
       h4("Congress has provided only a small fraction of the funds needed for recovery.
         ...
         less than 90% of the amount needed for recovery."),
       br(),
   ...
   tabPanel(h4("Funding Trends"), id = "panel3",
    fluidPage(
     fluidRow(br()),
     fluidRow(
       ...
       column(4,
              ...
              h4("Not only has Congress underfunded recovery for decades, but the amount of funding per species has decreased since 2010.
                 This drop has occurred across all endangered species programs at FWS.
                 This decline is the result of the ESA budget decreasing since 2010, combined with the continued increase in the number of listed species.
                 Prior to this decline, the per species budget had been stagnant for almost a decade.",
   ...
   tabPanel(h4("Spending Trends"), id = "panel4",
    fluidPage(
     fluidRow(br()),
     fluidRow(
